<script lang="ts">
    const ekibenList = [
        {
            ...
            price: 880,
            description:
                "都会的でありながら地元の自然や伝統を感じる駅弁。鱧をメインに沿線の特産や季節感を演出。",
            items: [
                "鱧の炙り寿司",
                "信州そばサラダ",
                "季節の煮物",
            ...
            character: "箸袋・パッケージにやきう（猫）イラスト入り",
            stations: ["華町駅", "闇ヶ丘中央駅", "附属病院前駅", "学文台駅"],
            image: "https://i.imgur.com/slWStq9.png",
        },
        {
            name: "梅（うめ）",
            price: 1600,
            description: "迷ったらこれ！安心感とボリュームのある定番弁当。",
            items: [
                "芋コロッケ",
                "唐揚げ",
                "A5ランクステーキ（ミニ）",
        ...
        },
        {
            ...
            price: 1330,
            description:
                "ありきたりな「のり弁」を駅弁らしく贅沢アレンジ。旅情と学食感のある一品。",
            items: [
                "焼き飯おにぎり",
                "焼きたて焼売",
                "新鮮アジフライ",
        ...
        },
        {
            name: "竹 おとなの煮物弁当",
            price: 1000,
            description: "年配層やビジネス客に人気。ほっとする味わい。",
            items: [
                "煮魚",
                "高野豆腐",
                "ひじき煮",
    ...
    const souvenirList = [
        ...
        },
        {
            ...
            price: "380円",
            description: `
            お土産にぴったりの新感覚煎餅登場！サクサクっとした食感の中に、絶妙な甘じょっぱさが広がる「粋杉煎餅」。
            一口食べれば、どこか懐かしくも新しい味わいが広がります。地元の特産素材をたっぷり使用し、パッケージもおしゃれ。`,
        },
        {
            name: "三新おやき",
            price: "4個 500円",
            description: `
            ボリュームたっぷり、小腹がすいた時にちょうどいいおやきです。三新のロゴ入りでお土産にも最適！！
            具は、こしあん、つぶあん、野沢菜、チーズがあります。冷凍と常温の二種類をご用意しています。`,
        },
        {
            name: "マルタ96型もなか",
            price: "360円〜",
            description: `
            当社の鉄道、マルタ96の見た目にしたもなかです。皮はパリパリしており、お子様や高齢の方にも食べやすい。
            味の種類：こしあん 360円、つぶあん 360円、カスタード 360円、皮だけ 260円
            ※皮だけは自分で餡を入れることで様々な味を楽しめます。`,
        },
    ];
</script>
            ...
            {#each ekibenList as ekiben}
                ...
                >
                    <div class="relative">
                        ...
                        />
                        <span
                            class="absolute top-3 right-3 bg-emerald-600 text-white text-xs font-semibold px-3 py-1 rounded-full shadow"
                        >
                            {ekiben.price}円
                        </span>
                    </div>
                    <div class="p-5 space-y-3">
                        ...
                        <div>
                            <h4
                                class="text-gray-800 font-semibold mb-1 text-sm"
                            >
                                内容
                            </h4>
                            <ul
                                class="list-disc list-inside text-gray-600 text-sm space-y-1"
                            >
                                {#each ekiben.items as item}
                                    <li>{item}</li>
                                {/each}
                            </ul>
                        </div>
                        ...
                        {#if ekiben.stations}
                            <div class="mt-2">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    {#each ekiben.stations as s}
                                        <span
                                            class="bg-emerald-100 text-emerald-800 px-2 py-1 rounded-full text-xs"
                                            >{s}</span
                                        >
                                    {/each}
                                </div>
